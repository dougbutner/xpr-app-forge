...
| `flextokens.md` | Flextokens (EASY, WON, MEME, GRAMS) | Reflection tax, reward choice, mon3y/m3m3/w3won actions |
...
| Module | Read When | Key Topics |
|--------|-----------|------------|
| `alcor-exchange.md` | Alcor DEX (WAX/EOS/Telos/XPR) | Swap `swap.alcor`, orderbook contracts, REST/WS API, farms, TWAP oracle, widgets |
